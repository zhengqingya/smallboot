...
public interface SysRolePermissionMapper extends BaseMapper<SysRolePermission> {
     ...
     */
    List<SysRoleMenuBtnListVO> selectDataListRoleReMenuBtn();
     ...
     * @date 2020/9/10 17:58
     */
    List<SysRoleRePermBO> selectRoleRePerm();
    ...
    void delByRoleIdAndMenuId(@Param("roleId") Integer roleId, @Param("menuId") Integer menuId);
