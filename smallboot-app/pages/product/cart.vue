<template>
	<view class="app-container">
		<view class="cart" v-show="cartList.length > 0">
			<view @tap="isShowDetail = true">
				<u-icon class="icon" size="25" name="car-fill"></u-icon>
				<u-badge class="num" max="99" :absolute="true"
					:value="cartList.reduce((total, item) => total += item.num, 0)"></u-badge>
