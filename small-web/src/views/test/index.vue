<template>
  <div class="bg-color-primary h100 w100 flex">
    <div class="bg-color-warning w-200">
      <h1>{{ $filters.sexName(1) }}</h1>
    </div>

    <div class="flex-1">
      <div class="bg-color-success font-size-100">123456789123456789</div>
      <span class="font-size-lg w-200 h-100 line-height-100 text-center bg-color-red display-block">hello</span>
