    ...
    <div style="width: 100%">
      <el-scrollbar>
        <base-right-click class="flex">
          <div v-for="item in tabsList" :key="item" class="item" :class="{ active: $route.meta.fullPath === item.meta.fullPath }">
            <div class="content" @click.right="handleRightClick(item, $event)">
